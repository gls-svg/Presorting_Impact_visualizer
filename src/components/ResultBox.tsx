...
const ResultBox: React.FC<ResultBoxProps> = ({ results, isLoading }) => {
  ...
  const speedup = sortedResult 
    ? (unsortedResult.executionTime / sortedResult.executionTime).toFixed(2)
    : 'N/A';
    ...
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
      ...
      <div className="space-y-6">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className={`bg-gray-50 p-4 rounded-md border border-gray-200 ${!sortedResult ? 'opacity-50' : ''}`}>
            ...
            {sortedResult ? (
              ...
              <p className="text-sm text-gray-500">Presorting is disabled</p>
            )}
          </div>
        </div>
        ...
        <div className="bg-blue-50 p-4 rounded-md border border-blue-200">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <span className="text-sm text-blue-700">Algorithm:</span>
